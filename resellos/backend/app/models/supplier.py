...
class ProductSource(Base):
    ...
    quantity_basis = Column(Text)
    proof_text = Column(Text)
    manual_verification_note = Column(Text)
    confidence_level = Column(String(20))
    economics_verified = Column(Boolean, default=False)
    verified_at = Column(DateTime)
    verified_by_source = Column(String(50))
...
class ProductIdea(Base):
    ...
    scout_status = Column(String(50))
    scout_score = Column(Integer)
    scout_confidence = Column(String(20))
    scout_reason = Column(Text)
    scout_next_step = Column(Text)
    scout_metrics_json = Column(Text)
    scout_updated_at = Column(DateTime)
